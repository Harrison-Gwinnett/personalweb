        ...
        <div style={{ display: 'flex', flexDirection: 'column', paddingBottom: '38px', paddingTop: '52px', width: '100%' }}>
          ...
          {principles.map(({ num, heading, body }, i) => (
            <FadeUp key={num} delay={0.34 + i * 0.06} style={{ width: '100%' }}>
              <div style={{ borderBottomColor: '#E2E0D5', borderBottomStyle: 'solid', borderBottomWidth: '1px', display: 'flex', flexDirection: 'column', gap: '8px', paddingBlock: '20px', width: '100%' }}>
